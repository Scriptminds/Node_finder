### Installation Instructions Node_finder
...
2. Copy & Paste the Node_finder file:
   - Copy the Node_finder paste into the plugins folder.
...
7. open nuke:
   ...
   -Restart the Nuke and now you can enjoy the Node_finder on the above toolbars.
